...
if("TRUE" STREQUAL "TRUE")
  set(arbotix_python_SOURCE_PREFIX /home/wukong/catkin_ws/src/Advanced-src/arbotix_ros/arbotix_python)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arbotix_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wukong/catkin_ws/src/Advanced-src/arbotix_ros/arbotix_python/${idir}'.  ${_report}")
    endif()
